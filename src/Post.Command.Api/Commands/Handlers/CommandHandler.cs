...
/// <summary>
/// A classe CommandHandler é a classe colega concreta (na implementação do padrão mediador) que manipula comandos invocando 
/// os métodos PostAggregate e EventSourcingHandler relevantes.
/// </summary>
